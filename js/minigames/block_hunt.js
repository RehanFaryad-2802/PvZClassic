const BlockHunt = (() => {
  ...
  function buildUI() {
    screen.innerHTML = `
      <div class="bh-container" id="bh-container">
        <div class="bh-header">
          <button class="btn-back" id="bh-back"><img src="assets/icons/back.png" alt="back" class="game-icon"></button>
          <h2>🎯 Block Hunt</h2>
          <div class="bh-stats">
  ...
  function showDifficultyPicker() {
    ...
    picker.innerHTML = `
    <button class="btn-back" style="align-self:flex-start;margin-bottom:8px" id="bh-pick-back"><img src="assets/icons/back.png" alt="back" class="game-icon"></button>
